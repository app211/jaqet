...
void DefaultScraper::internalSearchTV(QNetworkAccessManager* manager, const QString& toSearch, const QString& language) const{
    m_bannerScraper->searchTV(manager,toSearch,language);
}
...
QIcon DefaultScraper::loadIcon() const {
...
QString DefaultScraper::name() const {
    return QStringLiteral("Default");
}

QIcon DefaultScraper::icon() const {
    return m_icon;
}

bool DefaultScraper::supportLanguage(const QString& languageCodeISO639) const {
